...
public class ActionSauvegarder extends Action {
	...
	/**
	 * @param modele contenant la tourn�e � sauvegarder
	 * @return string pars� et format� contenant les �l�ments de la sauvegarde
	 */
	...
	/**
	 * m�thode de calcul de temps
	 * @param top temps initial
	 * @param delta d�lai d'attente � ajouter
	 * @return nouveau temps calcul�
	 */
